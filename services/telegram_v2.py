...
class TelegramBotV2:
    ...
    def __init__(self, token: Optional[str] = None, chat_ids: Optional[str] = None):
        self.token = token or settings.TELEGRAM_BOT_TOKEN
        self.chat_ids = self._parse_chat_ids(chat_ids or getattr(settings, 'TELEGRAM_CHAT_IDS', None) or settings.TELEGRAM_CHAT_ID)
    ...
    def _parse_chat_ids(self, chat_ids_str: Optional[str]) -> List[Union[int, str]]:
    ...
    async def send_photo(self, photo_path: Union[str, Path], caption: Optional[str] = None) -> bool:
    ...
    async def send_document(self, document_path: Union[str, Path], caption: Optional[str] = None) -> bool:
...
def send_text_sync(text: str, parse_mode: Optional[str] = None) -> bool:
...
def send_photo_sync(photo_path: Union[str, Path], caption: Optional[str] = None) -> bool:
