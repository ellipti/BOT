...
class TestPrompt26TrailingOptimizations:
    ...
    def create_mock_position(self, ticket=12345, symbol="XAUUSD", price_open=2500.0, 
                           price_current=2510.0, sl=None, position_type=0, volume=0.1):
    ...
    def test_sl_only_moves_forward(self):
        ...
        buy_position = self.create_mock_position(
            position_type=0, price_open=2500.0, price_current=2495.0, sl=2498.0  # Loss position
        )
        ...
        sell_position = self.create_mock_position(
            position_type=1, price_open=2500.0, price_current=2505.0, sl=2502.0  # Loss position
        )
    ...
    def test_integrated_position_processing(self):
        ...
        positions = [
            self.create_mock_position(ticket=1, price_open=2500.0, price_current=2515.0),  # Profitable
            self.create_mock_position(ticket=2, price_open=2520.0, price_current=2518.0),  # Small loss
        ]
    ...
    def test_error_handling_and_robustness(self):
        ...
        new_sl = self.trailing_manager.compute_trailing_sl(
            position=position,
            use_atr=True,
            recent_candles=invalid_candles
        )
