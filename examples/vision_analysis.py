...
from core.vision_context import build_vision_context, VisionContext
from core.vision_schema import validate_trade_decision, TRADE_DECISION_SCHEMA

def analyze_chart_with_context(chart_images: List[bytes], symbol: str, timeframe: int) -> Dict[str, Any]:
    """
    ...
    decision = {
        "overlays": {
            ...
            "fibonacci": [
                {
                    "id": "fib1",
                    "swing_high": {"time": "2025-09-01T09:00:00Z", "price": context.high},
        ...
        "notes": [
            "Example note - waiting for confirmation"
        ]
    }
