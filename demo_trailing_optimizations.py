...
def demo_trailing_optimizations():
    ...
    logger.info(
        f"Position: XAUUSD BUY @ {position.price_open}, Current: {position.price_current}, SL: {position.sl}"
    )
    ...
    logger.info(
        f"Position: XAUUSD BUY @ {position_be.price_open}, Current: {position_be.price_current}, SL: {position_be.sl}"
    )
