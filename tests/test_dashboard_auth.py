...
from dashboard.auth import create_access_token, create_refresh_token, hash_password, verify_password
...
class TestUserStore:
    ...
    def test_role_validation(self):
        ...
        user_id = self.user_store.create_user(email, password, ["viewer", "trader", "admin"])
    ...
    def test_update_user_roles(self):
        ...
        # Update roles
        success = self.user_store.update_user_roles(user_id, ["viewer", "trader", "admin"])
        assert success
...
class TestDashboardAuth:
    ...
    def setup_method(self):
        ...
        # Create test users
        self.viewer_id = self.user_store.create_user("viewer@example.com", "password", ["viewer"])
        self.trader_id = self.user_store.create_user("trader@example.com", "password", ["trader"])
        self.admin_id = self.user_store.create_user("admin@example.com", "password", ["admin"])
