...
class TestNormalizedATR:
    ...
    def test_compute_norm_atr_volatility_differences(self):
        ...
        assert high_atr > low_atr, f"High vol ATR {high_atr} should > low vol ATR {low_atr}"
...
class TestReturnVolatility:
    ...
    def test_return_volatility_reflects_price_movement(self):
        ...
        assert volatile_vol > stable_vol, "Volatile candles should have higher return vol"
...
class TestRegimeDetector:
    ...
    def test_regime_stability_mechanism(self):
        ...
        regime4 = detector.detect(high_candles, "TEST")  # Should still be normal due to stability
    ...
    def test_get_params_for_regime(self):
        ...
        assert low_params["RISK_PCT"] > normal_params["RISK_PCT"] > high_params["RISK_PCT"]
