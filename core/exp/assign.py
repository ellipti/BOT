...
class ExperimentAssigner:
    ...
    def assign_arm(self, symbol: str, user_id: str | None = None) -> tuple[str, dict]:
        """
    ...
    def _hash_assign(self, symbol: str, hour_bucket: int, user_id: str | None) -> str:
...
def assign_arm(symbol: str, user_id: str | None = None) -> tuple[str, dict]:
    """
